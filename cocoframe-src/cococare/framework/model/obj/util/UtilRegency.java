...
@CCTypeConfig(label = "Regency", uniqueKey = "name", parameter = true)
public class UtilRegency implements CCEntity {
...
//</editor-fold>
    @Column(length = 8)
    @CCFieldConfig(componentId = "txtCode", accessible = Accessible.MANDATORY, maxLength = 8, sequence = "R000", unique = true, visible = false)
    private String code;
    @Column(length = 48)

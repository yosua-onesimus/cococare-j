...
public class PnlCustomerPhoneList extends javax.swing.JPanel {

    public PnlCustomerPhoneList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabEntity.addTab(SaleLanguage.turn(SaleLanguage.Customer_Phone), pnlList);

...
public class PnlVoucherTypeList extends javax.swing.JPanel {

    public PnlVoucherTypeList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabEntity.addTab(SaleLanguage.turn(SaleLanguage.Voucher_Type), pnlList);

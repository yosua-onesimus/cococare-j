...
public class PnlActionAttributeList extends javax.swing.JPanel {

    public PnlActionAttributeList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabEntity.addTab(FableLanguage.turn(FableLanguage.Attribute), pnlList);

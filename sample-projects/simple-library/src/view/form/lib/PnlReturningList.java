 ...
 * @version 13.03.17
 */
public class PnlReturningList extends javax.swing.JPanel {

    public PnlReturningList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabEntity.addTab(LibraryLanguage.turn(LibraryLanguage.Returning), pnlList);

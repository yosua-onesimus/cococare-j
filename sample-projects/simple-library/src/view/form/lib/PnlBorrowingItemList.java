 ...
 * @version 13.03.17
 */
public class PnlBorrowingItemList extends javax.swing.JPanel {

    public PnlBorrowingItemList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabEntity.addTab(LibraryLanguage.turn(LibraryLanguage.Book), pnlList);
